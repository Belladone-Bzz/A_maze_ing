...
- **Imperfect maze generation utility**
	...
	- `angles_opener(self) -> Generator[None]`: Part of the braided algorithm, ensuring no dead-end remains in the maze. This step is opening up angles of the maze. It first finds which wall is closed, opens it, and places it back by 'rotating' it inward. Yields None each time a wall is placed back.
